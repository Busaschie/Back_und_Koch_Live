...
pg = st.navigation([page_vorgaenge, page_user, page_waren, page_waren_druck, page_einkaufszettel_druck, page_hausgeld, page_userkonto, page_bestellung])
#pg = st.navigation([page_vorgaenge, page_user, page_waren])
pg.run()